...
object ResponseResultUtils {
	...
	fun makeResponse(result: Boolean, resultCode: String, resultMessage: String): ResponseUserHeaderVo =
		ResponseUserHeaderVo(result = result, resultCode = resultCode, resultMessage = resultMessage)
	...
	fun makeResponse(result: Boolean, code: ResponseResultCodeType): ResponseUserHeaderVo =
		makeResponse(result, code.value, code.description)
	...
	fun makeResponse(
		...
		makeResponse(result, code.value, code.description, transactionId, transactionDate)
}
